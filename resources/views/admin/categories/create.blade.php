...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Add Category</h1>

    <div class="bg-white rounded-none shadow p-8">
        <form method="POST" action="{{ route('admin.categories.store') }}" data-turbo="false">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" required
                       ...
                       value="{{ old('name') }}" placeholder="e.g., Shirts">
                @error('name')
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" class="bg-brand-primary text-white px-6 py-2 rounded-none hover:bg-brand-dark">Create Category</button>
            </div>
        </form>
    </div>
</div>
